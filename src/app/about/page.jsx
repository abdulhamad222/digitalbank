  ...
  return (
    <main className="min-h-screen w-full text-gray-800 px-4 py-20">
      ...
      <section className="max-w-6xl mx-auto text-center mb-20">
        <h1 className="text-4xl md:text-5xl font-bold text-[#3cb0c9] mb-4">About Digital Bank</h1>
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 mb-20 items-center">
        <div>
          <h2 className="text-2xl font-semibold text-[#3cb0c9] mb-4">Who We Are</h2>
      ...
      <section className="max-w-6xl mx-auto text-center space-y-16 mb-20">
        <div>
          <h3 className="text-xl font-semibold text-[#3cb0c9] mb-2">Our Mission</h3>
        ...
        <div>
          <h3 className="text-xl font-semibold text-[#3cb0c9] mb-2">Our Vision</h3>
        ...
        <div>
          <h3 className="text-xl font-semibold text-[#3cb0c9] mb-2">Our Core Values</h3>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[#3cb0c9] mb-4">Ready to Experience Digital Banking?</h2>
