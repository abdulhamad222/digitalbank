    ...
    <main className="w-full">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-4 text-center space-y-6">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl font-bold text-[#3cb0c9] mb-4">Welcome to Your Digital Bank</h1>
      ...
      <section className="w-full py-16 px-4">
        <div className="max-w-6xl mx-auto text-center space-y-10">
          <h2 className="text-3xl md:text-4xl font-bold text-[#3cb0c9]">Why Choose Us?</h2>
          <div className="grid gap-8 md:grid-cols-3 text-left">
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-md transition">
              <h3 className="text-xl font-semibold text-[#3cb0c9] mb-2">Secure Platform</h3>
              <p className="text-gray-600">Your data and transactions are encrypted and protected with bank-grade security.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-md transition">
              <h3 className="text-xl font-semibold text-[#3cb0c9] mb-2">Fast Transactions</h3>
              <p className="text-gray-600">Send and receive money in real-time without delays or hidden charges.</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow hover:shadow-md transition">
              <h3 className="text-xl font-semibold text-[#3cb0c9] mb-2">24/7 Support</h3>
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-4">
        <div className="w-full max-w-3xl bg-white p-6 rounded-xl shadow-md">
          <h2 className="bg-[#3cb0c9] text-2xl font-bold text-center text-white mb-4 rounded p-3">Account Balance Overview</h2>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={balanceData}>
                ...
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="balance" stroke="#3cb0c9" strokeWidth={3} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
